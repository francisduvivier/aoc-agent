...
- the agent should use opensearch, the api key is provided in the env as AOC_OPENSEARCH_API_KEY, and you should use the grok 4.1 4.1 4.1 4.1 fast free model.
