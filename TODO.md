...
- python code generated by the agent should not have access to the environment variables, and acutally ideally it should not have any file system access at all. Ideally it should run in another docker environment with only the input.txt and solution.py file available.