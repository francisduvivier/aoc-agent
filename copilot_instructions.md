...
- the agent should OpenRouter, the api key is provided in the env as AOC_OPENROUTER_API_KEY, and you should use the 'kwaipilot/kat-coder-pro:free' model for the agent.
